...
using sintransa_api_restful.Middlewares.ApiWrapper;
using sintransa_api_restful.Middlewares.ApiWrapper.Wrappers;
...
namespace sintransa_api_restful.Controllers
{
    ...
    {
        protected readonly SintransaDbContext _db;
        protected readonly IConfiguration _config;
        protected readonly IStringLocalizer<SharedResource> _stringLocalizer;

        public AppController(SintransaDbContext db, IConfiguration configuration, IStringLocalizer<SharedResource> stringLocalizer) { _db = db; _config = configuration; _stringLocalizer = stringLocalizer; }
